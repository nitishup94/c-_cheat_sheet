...
2. [Data Types](#-data-types)  
   - [Fundamental / Basic Types](#fundamental--basic-data-types)  
   - [Type Modifiers](#type-modifiers)  
   - [Derived Types](#derived-data-types)  
     - [Array](#array)  
     - [Pointer](#pointer)  
     - [Reference](#reference)  
...
6. [Pointers & References](#-pointers--references)  
   - [Pointers Basics](#pointers-basics)  
   - [Pointer Arithmetic](#pointer-arithmetic)  
   - [Pointer to Pointer](#pointer-to-pointer)  
   - [Null Pointer & Dangling Pointer](#null-pointer--dangling-pointer)  
...
7. [OOP in C++](#-oop-in-c)  
   ...
   - [Polymorphism](#polymorphism)  
     - [Compile-time (Function Overloading / Operator Overloading)](#compile-time-polymorphism)  
     - [Run-time (Virtual Functions)](#run-time-polymorphism)  
   - [Encapsulation & Abstraction](#encapsulation--abstraction)  
   - [Friend Functions & Classes](#friend-functions--classes)  
